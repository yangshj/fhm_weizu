...
@Controller
@RequestMapping(value="/weizu/addressLookAuth")
public class AddressLookAuthController extends BaseController {
    ...
    public ModelAndView listUsers(Page page){
        ...
        try{
            ...
            page.setPd(pd);
            List<PageData> userList = addressLookAuthService.getAllAuthRequestlistPage(page);	//列出用户列表
            ...
            mv.setViewName("weizu/addressLookAuth/list");
